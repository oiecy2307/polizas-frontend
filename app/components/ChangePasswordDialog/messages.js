/*
 * ChangePasswordDialog Messages
 *
 * This contains all the text for the ChangePasswordDialog component.
 */

import { defineMessages } from 'react-intl';

export const scope = 'app.components.ChangePasswordDialog';
...
export default language => {
  ...
  return defineMessages({
    header: {
      id: `${scope}.header`,
      defaultMessage: 'This is the ChangePasswordDialog component!',
    },
    fields: {
