/*
 * CreateEditProduct Messages
 *
 * This contains all the text for the CreateEditProduct component.
 */

import { defineMessages } from 'react-intl';

export const scope = 'app.components.CreateEditProduct';
...
export default language => {
  ...
  return defineMessages({
    header: {
      id: `${scope}.header`,
      defaultMessage: 'This is the CreateEditProduct component!',
    },
    fields: {
