/*
 * CreateEditSolution Messages
 *
 * This contains all the text for the CreateEditSolution component.
 */

import { defineMessages } from 'react-intl';

export const scope = 'app.components.CreateEditSolution';
...
export default language => {
  ...
  return defineMessages({
    header: {
      id: `${scope}.header`,
      defaultMessage: 'This is the CreateEditSolution component!',
    },
    fields: {
